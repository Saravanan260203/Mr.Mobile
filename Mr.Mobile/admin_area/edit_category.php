...
?>
  ...
  <input type="hidden" name="edit_id" value="<?php echo $row['category_id'] ?>">
    ...
    <input type="text" class="form-control"  name="category_name"  value="<?php echo $row['category_name'] ?>" placeholder="Edit Brand Name" required>
  </div>

  <a href="admin_index.php" class="btn bg-danger mb-5">Cancel</a>
  <input type="submit" value="Save Changes" class="btn bg-info mb-5" name="update_category">
</form>
<?php
    }}
    ?>
